//=============================================
//This script is used for lobby creation and network connection data acquisition
//=============================================
using System;
...
namespace SteamMultiplayer.Lobby
{
    ...
    public class NetworkLobbyManager : MonoBehaviour
    {
        ...
        //Chating
        [HideInInspector] public string chatstring = null;

        public CSteamID host
        {
            get { return NetworkControl.PlayerList[0]; }
        }

        public bool isHost
        {
            get { return NetworkControl.SelfID == host; }
        }
